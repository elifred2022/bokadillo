...
import type { CompraList, ArticuloCompra, Proveedor, Articulo } from "@/lib/types";
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 overflow-y-auto">
      <div className="w-full max-w-lg rounded-xl bg-white p-6 shadow-xl my-8">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div>
            <label htmlFor="factura" className="mb-1 block text-sm font-medium text-slate-700">
              Factura
            </label>
            <input
              id="factura"
