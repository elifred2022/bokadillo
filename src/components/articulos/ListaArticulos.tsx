            ...
            <table className="w-full min-w-[400px]">
              <thead>
                <tr className="bg-red-100">
                  ...
                  <th className="px-3 sm:px-5 py-3 text-left text-xs sm:text-sm font-semibold text-red-800 whitespace-nowrap">Precio</th>
                  <th className="px-3 sm:px-5 py-3 text-left text-xs sm:text-sm font-semibold text-red-800 whitespace-nowrap">Stock</th>
